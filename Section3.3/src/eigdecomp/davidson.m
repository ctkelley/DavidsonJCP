function [X,lambda,LVEC,RVEC] = davidson(H, X0, prec, tol, maxit, verbose)
%
% Usage: [X,lambda,LVEC,RVEC] = davidson(H, X0, prec, tol, maxit, verbose);
%
% Purpose:
